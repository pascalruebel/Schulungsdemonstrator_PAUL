...
class StorageStation(Actor):
    ...
    def __init__(self, name, motor, carriage, rack, status_led, blinker, topics=None):
        ...
        self.input_events = events.StationInputEvent(events.StationInputEvents.NoEvent, self.name)
        self.output_events = events.GenericServiceEvent(events.GenericServiceEvents.NoEvent, self.name)
