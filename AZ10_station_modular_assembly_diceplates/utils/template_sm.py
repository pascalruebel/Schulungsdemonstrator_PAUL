...
class SubStateA(BaseState):
    """ Concrete class for the substate A of the complex State1 """
    def __init__(self, context_sm, super_sm=None, isSubstate=False):
...
class SubStateB(BaseState):
    """ Concrete class for the substate B of the complex State1 """
    def __init__(self, context_sm, super_sm=None, isSubstate=False):
...
templateSM.dispatch(topic="event", value="toState2")
templateSM.dispatch(topic="event", value="toStateA")
